...
public class BlockBreakEvent {
    ...
    public static void onBlockBreak(BlockEvent.BreakEvent event) {
        if (!event.getLevel().isClientSide())
        {
            ...
            LootContext.Builder builder = new LootContext.Builder(Objects.requireNonNull(Objects.requireNonNull(event.getLevel().getServer()).getLevel(player.level.dimension())))
