package me.blubby.bmod.client.model;
...
public class NightmareHelmetModel<E extends LivingEntity> extends EntityModel<E> implements HeadedModel {
    private final ModelPart head;

    public NightmareHelmetModel(ModelPart head) {
        this.head = head;
    }
