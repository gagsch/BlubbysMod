...
public class ModItems {
    ...
    public static final Supplier<Item> FLIPPER = ITEMS.register("flipper", FlipperItem::new);
    public static final Supplier<Item> OXYGEN_TANK = ITEMS.register("oxygen_tank", AccessoryItem::new);
